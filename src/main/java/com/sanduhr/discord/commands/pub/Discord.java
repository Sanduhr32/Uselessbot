...
public class Discord extends ListenerAdapter {
    ...
    private void initter() {
        ...
        zitate.add("Discord: [@Mondanzo]() [@Sanduhr32]("+SANDUHR+") [Wie bedient man denn das Alles mit 10 Fingern? :-P](https://twitter.com/discordapp/status/848151502376095744)\nSanduhr: [@discordapp]("+ DISCORD +") [@Mondanzo]() [Einfach ein paar finger_int.dll laden \uD83D\uDE02](https://twitter.com/Sanduhr32/status/848161744061116416)");
        ...
        zitate.add("\u2764 [@discordapp]("+DISCORD+") gefällt dein Tweet\n[Lifegoal: Von](https://twitter.com/Sanduhr32/status/835513741315878913) [@discordapp]("+DISCORD+") [gelobt werden: ✔\n" +
