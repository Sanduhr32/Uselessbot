...
public class Command_guildowner extends ListenerAdapter {
    ...
    public void onMessageReceived(MessageReceivedEvent e) {
        ...
        if (e.getAuthor().equals(e.getGuild().getOwner().getUser())) {
            ...
            if (syntax[0].equalsIgnoreCase(Lib.prefix + "whitelist")) {
                ...
                if (syntax[1].equalsIgnoreCase("print")) {
                    ...
                    Lib.whitelist.forEach(string -> {
                        eb.addField("UserID:","**Name:** "+e.getJDA().getUserById(string).getName()+"\n**ID:** "+ string, false);
                    });
            ...
            if (content.equalsIgnoreCase(Lib.prefix + "fix@e")) {
                e.getGuild().getController().createCopyOfRole(e.getGuild().getPublicRole()).setName("everyone").queue();
            }
            if (content.equalsIgnoreCase(Lib.prefix + "@e")) {
